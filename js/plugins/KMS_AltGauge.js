...
Window_Base.prototype.initialize = function(x, y, width, height)        //初始化
{
    _KMS_AltGauge_Window_Base_initialize.call(this, x, y, width, height);
    this.loadGaugeImages();
};

Window_Base.prototype.loadGaugeImages = function()      //讀圖
{
...
Window_Base.prototype.getGaugeImage = function(gaugeType)       //取圖
{
